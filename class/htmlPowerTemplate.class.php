...
class TemplatePowerParser
{
  ...
  var $version;
   ...
   function __prepare()
   {
       ...
       $this->globalvars[ 'localPath' ] = LOCAL_PATH;       
       
       $this->globalvars[ 'urlAreaProfessor' ] = URL_AREA_PROFESSOR;
       $this->globalvars[ 'urlAreaAluno' ] = URL_AREA_ALUNO;
       $this->globalvars[ 'urlAreaAlunoNova' ] = URL_AREA_ALUNO_NOVA;
       $this->globalvars[ 'urlCatalogoBiblioteca' ] = URL_CATALOGO_BIBLLIOTECA;
       $this->globalvars[ 'urlMoodle' ] = URL_MOODLE;
       $this->globalvars[ 'urlGVCollege' ] = URL_GVCOLLEGE;     
